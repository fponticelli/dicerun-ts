...
class XMLHttpRequest extends XMLHttpRequestEventTarget_1.default {
    ...
    send(data) {
        ...
        const url = new url_1.URL(this._settings.url, location);
        // Security check.
    ...
    _sendSyncRequest(options, ssl, data) {
        ...
        if (error) {
            ...
            this._state.responseXML = null;
            this._state.responseURL = new url_1.URL(this._settings.url, this._ownerDocument.defaultView.location).href;
            // Set Cookies.
            ...
            if (this._state.incommingMessage.statusCode === 301 ||
                ...
                const redirectUrl = new url_1.URL(this._state.incommingMessage.headers['location'], this._ownerDocument.defaultView.location);
    ...
    _onAsyncResponse(response, options, ssl, data) {
        return new Promise((resolve) => {
            ...
            if (this._state.incommingMessage.statusCode === 301 ||
                ...
                // Parse the new URL.
                const redirectUrl = new url_1.URL(this._settings.url, this._ownerDocument.defaultView.location);
                this._settings.url = redirectUrl.href;
                ssl = redirectUrl.protocol === 'https:';
